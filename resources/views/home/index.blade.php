        ...
        @foreach ($sp as $i => $v)
            @if ($i % 5 == 0)
                <div class="col-12 col-md-4 p-5 mt-3">
                    <img src="/assets/{{$v['images']}}" class="rounded-circle img-fluid border">
                    <h5 class="text-center mt-3 mb-3">{{$v['name']}}</h5>
                    <p class="text-center"><a href="/{{$v['idCat']}}/{{$v['slug']}}" class="btn btn-success">Go Shop</a></p>
                </div>
            @endif
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="/assets/{{$i['images']}}" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <li class="text-muted text-right">{{number_format($i['gia'])}} đ</li>
                            </ul>
                            <a href="/{{$i['idCat']}}/{{$i['slug']}}"
                                class="h2 text-decoration-none text-dark">{{$i['name']}}</a>
                            <p class="card-text">
